...
class ProductoSucursalx extends Controller
{
    ...
    public function update(Request $request){
      ...
      $ProductoSucursal = ProductoSucursal::findOrFail($request->id);
 ...
 //$sucursal= "{$valorsucursal->nombre} ";
    ...
    public function updateprecio(Request $request) {
      ...
      $productosucusal = ProductoSucursal::where('producto_id',$request->id)->join('sucursal', 'sucursal.id',
      '=','sucursal_id' )->get();

    // dd($productosucusal);
      return view('productosucursalform', ['productosucursal'=>$productosucusal]);
